  ...
  return (
    <div className={`${props.page_id === '0' ? '' : 'ml-16'} w-full`}>
      ...
      <div>
            ...
            <input type="email" className='bg-slate-100 border-2 border-slate-700 rounded font-1 p-3 text-xl w-2/4'  value={emailId}/>
      </div>
      ...
      <div className='mt-6'>
            ...
            <input type="email" className='bg-slate-100 border-2 border-slate-700 rounded font-1 p-3 text-xl w-2/4' disabled={props.page_id === '0' ? true : false} />
      </div>
      {/* inputs for email writer and emailer end */}
      ...
      {/* button for send */}
    {props.page_id === '0' ? <span></span> : <div className='flex mt-4'>
      <button className='bg-green-400 p-1 font-1 text-xl text-white rounded '>send</button>
    </div>}
      {/* button for send end */}
    </div>
  )
